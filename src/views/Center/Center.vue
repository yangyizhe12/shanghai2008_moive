            ...
            <div class="center-view">
                <div class="avatar">
                    <img v-if="!user_info.headIcon"
                        ...
                        class="avator-icon"
                    />
                    <img v-if="user_info.headIcon" :src="user_info.headIcon" class="avator-icon">
                    <div v-if="user_info.userId" class="nick-name" >{{user_info.mobile}}</div>
                    <div v-if="!user_info.userId" class="nick-name" @click="login()">立即登录</div>
                    <div v-if="user_info.userId" class="nick-name" @click="exit()">退出登录</div>
                    <div></div>
                </div>
...
export default {
    ...
    async mounted(){
        ...
        if( _token){
            ...
            this.user_info = ret.data.user_info
        }
    },
    methods: {
        login: function(){
